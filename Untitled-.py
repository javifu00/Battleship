...
def datos_usuario():
    ...
    while username_repetido:
        ...
        for x in datos:
            ...
            while verificacion_edad == False or int(edad)<5 or int(edad)>100:
                print("{}Por favor ingresa su edad en numeros, o ingrese otro valor{}".format(Fore.LIGHTRED_EX, Fore.RESET))
                edad = input("Ingrese su edad: ")
                verificacion_edad = edad.isdigit()
            genero = input("Ingrese su genero: \n1) Femenino \n2) Masculino \n3) Ninguno\n")
            verificacion_genero = genero.isdigit()
            while verificacion_genero == False or int(genero)<1 or int(genero)>3:
                print("{}Por favor ingresa el numero correspodiente{}".format(Fore.LIGHTRED_EX, Fore.RESET))
                genero = input("Ingrese su genero: \n1) Femenino \n2) Masculino \n3) Ninguno\n")
                verificacion_genero = genero.isdigit()
            if genero == "1":
                genero = "Femenino"
...
def juego():
    ...
    sleep(0.7)
    print("\nCargando tus estadisticas :| .....       pssss deberias probar el numero de kobe y jordan en fila y columana\n")
    sleep(2.5)
    for x in usuario_partida:
...
3 - Edad
4 - Género
El puntaje no lo puedes cambiar, no seas chiguire
    """)
